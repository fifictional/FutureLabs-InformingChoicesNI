...
--> statement-breakpoint
CREATE UNIQUE INDEX `unique_submission_per_form` ON `submissions` (`form_id`,`external_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `unique_response_per_question_and_submission` ON `responses` (`submission_id`,`question_id`);
